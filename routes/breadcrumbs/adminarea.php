...
Breadcrumbs::register('adminarea.cortex.pages.pages.index', function (Generator $breadcrumbs) {
    $breadcrumbs->push('<i class="fa fa-dashboard"></i> '.config('app.name'), route('adminarea.home'));
    $breadcrumbs->push(trans('cortex/pages::common.pages'), route('adminarea.cortex.pages.pages.index'));
});

Breadcrumbs::register('adminarea.cortex.pages.pages.import', function (Generator $breadcrumbs) {
...
Breadcrumbs::register('adminarea.cortex.pages.pages.import.logs', function (Generator $breadcrumbs) {
    $breadcrumbs->parent('adminarea.cortex.pages.pages.index');
    $breadcrumbs->push(trans('cortex/pages::common.import'), route('adminarea.cortex.pages.pages.import'));
    $breadcrumbs->push(trans('cortex/pages::common.logs'), route('adminarea.cortex.pages.pages.import.logs'));
});

Breadcrumbs::register('adminarea.cortex.pages.pages.create', function (Generator $breadcrumbs) {
    $breadcrumbs->parent('adminarea.cortex.pages.pages.index');
    $breadcrumbs->push(trans('cortex/pages::common.create_page'), route('adminarea.cortex.pages.pages.create'));
});

Breadcrumbs::register('adminarea.cortex.pages.pages.edit', function (Generator $breadcrumbs, Page $page) {
    $breadcrumbs->parent('adminarea.cortex.pages.pages.index');
    $breadcrumbs->push(strip_tags($page->title), route('adminarea.cortex.pages.pages.edit', ['page' => $page]));
});

Breadcrumbs::register('adminarea.cortex.pages.pages.logs', function (Generator $breadcrumbs, Page $page) {
    $breadcrumbs->parent('adminarea.cortex.pages.pages.index');
    $breadcrumbs->push(strip_tags($page->title), route('adminarea.cortex.pages.pages.edit', ['page' => $page]));
    $breadcrumbs->push(trans('cortex/pages::common.logs'), route('adminarea.cortex.pages.pages.logs', ['page' => $page]));
});

Breadcrumbs::register('adminarea.cortex.pages.pages.media.index', function (Generator $breadcrumbs, Page $page) {
    $breadcrumbs->parent('adminarea.cortex.pages.pages.index');
    $breadcrumbs->push(strip_tags($page->title), route('adminarea.cortex.pages.pages.edit', ['page' => $page]));
