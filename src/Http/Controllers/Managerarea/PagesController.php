...
class PagesController extends AuthorizedController
{
    ...
    protected function process(FormRequest $request, Page $page)
    {
        ...
        return intend([
            ...
            'with' => ['success' => trans('cortex/foundation::messages.resource_saved', ['resource' => 'page', 'identifier' => $page->slug])],
        ]);
    }
    ...
    public function destroy(Page $page)
    {
        ...
        return intend([
            'url' => route('managerarea.pages.index'),
            'with' => ['warning' => trans('cortex/foundation::messages.resource_deleted', ['resource' => 'page', 'identifier' => $page->slug])],
        ]);
    }
}
