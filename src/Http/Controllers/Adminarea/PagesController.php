...
class PagesController extends AuthorizedController
{
    ...
    public function logs(Page $page, LogsDataTable $logsDataTable)
    {
        return $logsDataTable->with([
            ...
            'id' => "adminarea-pages-{$page->getRouteKey()}-logs",
    ...
    public function import(Page $page, ImportRecordsDataTable $importRecordsDataTable)
    {
        return $importRecordsDataTable->with([
            ...
            'id' => "adminarea-pages-{$page->getRouteKey()}-import",
    ...
    public function importLogs(ImportLogsDataTable $importLogsDatatable)
    {
        return $importLogsDatatable->with([
            ...
            'tabs' => 'adminarea.pages.tabs',
            'id' => 'adminarea-pages-import-logs',
        ])->render('cortex/foundation::adminarea.pages.datatable-tab');
    }
    ...
    protected function process(FormRequest $request, Page $page)
    {
        ...
        return intend([
            ...
            'with' => ['success' => trans('cortex/foundation::messages.resource_saved', ['resource' => trans('cortex/pages::common.page'), 'identifier' => strip_tags($page->name)])],
        ]);
    }
    ...
    public function destroy(Page $page)
    {
        ...
        return intend([
            'url' => route('adminarea.pages.index'),
            'with' => ['warning' => trans('cortex/foundation::messages.resource_deleted', ['resource' => trans('cortex/pages::common.page'), 'identifier' => strip_tags($page->name)])],
        ]);
    }
}
