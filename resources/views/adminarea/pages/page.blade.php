...
@push('inline-scripts')
    {!! JsValidator::formRequest(Cortex\Pages\Http\Requests\Adminarea\PageFormRequest::class)->selector("#adminarea-pages-create-form, #adminarea-pages-{$page->getRouteKey()}-update-form") !!}
@endpush
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group{{ $errors->has('title') ? ' has-error' : '' }}">
                                                ...
                                                {{ Form::text('title', null, ['class' => 'form-control', 'placeholder' => trans('cortex/pages::common.title'), 'data-slugify' => '[name="name"]', 'required' => 'required', 'autofocus' => 'autofocus']) }}
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                                                {{ Form::label('name', trans('cortex/pages::common.name'), ['class' => 'control-label']) }}
                                                {{ Form::text('name', null, ['class' => 'form-control', 'placeholder' => trans('cortex/pages::common.name'), 'required' => 'required']) }}
